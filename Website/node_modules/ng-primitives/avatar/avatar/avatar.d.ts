...
export declare class NgpAvatar {
     ...
     * The avatar state.
     */
    protected readonly state: import("ng-primitives/state").CreatedState<NgpAvatar>;
    /**
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgpAvatar, "[ngpAvatar]", ["ngpAvatar"], {}, {}, never, never, true, never>;
}
